...
if [ -z "$1" ]; then
    ...
    echo "3. Select 'URL prefix' and enter: ${GREEN}https://www.insightlearn.cloud${NC}"
...
echo -e "   ${GREEN}curl https://www.insightlearn.cloud/${VERIFICATION_CODE}.html${NC}"
echo ""
...
echo -e "   - Add: ${GREEN}https://www.insightlearn.cloud/sitemap.xml${NC}"
echo ""
